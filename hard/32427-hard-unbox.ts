...
type Unbox<TOG, D extends number = 0, R extends unknown[] = []> = TOG extends (infer A)[]
  ? Unbox<A, D, [...R, A]>
  : TOG extends Promise<infer B>
    ? Unbox<B, D, [...R, B]>
    : TOG extends () => infer C
      ? Unbox<C, D, [...R, C]>
      :  D extends 0 ? TOG : [1,...R][D] extends undefined ? TOG : [1,...R][D]
      

/* _____________ Test Cases _____________ */
import type { Equal, Expect } from '@type-challenges/utils'
type Test2 = Unbox<() => () => () => () => number, 5>;
